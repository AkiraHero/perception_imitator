...
class InputRepresentation:
    ...
    def make_input_representation(self, ego_pose_token: str, sample_token: str) -> np.ndarray:

        static_layers = self.static_layer_rasterizer.make_representation(ego_pose_token, sample_token)
        agents = self.agent_rasterizer.make_representation(ego_pose_token, sample_token)
