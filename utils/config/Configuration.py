...
class Configuration:
    ...
    def get_shell_args_train(self):
        ...
        parser.add_argument('--distributed', action='store_true', default=False, help='using distributed training')
        ...
        parser.add_argument('--check_point_file', type=str, default=None,
    ...
    def get_shell_args_test(self):
        ...
        parser.add_argument('--batch_size', type=int, default=None, required=False,
                            help='batch size for training (in each process in distributed training)')
        parser.add_argument('--distributed', action='store_true', default=False, help='using distributed testing')
